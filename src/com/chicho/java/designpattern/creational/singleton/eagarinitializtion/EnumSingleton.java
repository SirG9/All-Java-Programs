 ...
 * Joshua Bloch suggests the use of Enum to implement Singleton design pattern as 
 ...
 * The drawback is that the enum type is somewhat inflexible; for example, it does not allow 
 * lazy initialization.*/
