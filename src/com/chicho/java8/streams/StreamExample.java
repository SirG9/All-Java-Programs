...
public class StreamExample {
	...
	public static void main(String[] args) {
		...
		Stream<String> genStream = Stream.generate(() -> "abc");

		Stream<String> iterateStream = Stream.iterate("abc", (i) -> i);
		...
		// use toArray() method to create an array from stream
		...
		Stream<Integer> highNumsSeq = sequentialStream.filter(p -> p > 90); // filter
																			// numbers
																			// greater
																			// than
																			// 90
		...
		Stream<List<String>> namesOriginalList = Stream.of(Arrays.asList("Preethi"),
				Arrays.asList("Devendra", "Sandip"), Arrays.asList("Madhuri"));
		...
		Stream<String> names4 = Stream.of("Preethi", "Sandip", "Devendra", "Madhuri");
		Optional<String> firstNameWithD = names4.filter(i -> i.startsWith("D")).findFirst();
		if (firstNameWithD.isPresent()) {
			System.out.println("First Name starting with D=" + firstNameWithD.get()); // Devendra
		}
	}
